...
# Buy: Alligator "awake" (Lips > Teeth > Jaw) + ST bullish
df['Buy'] = (df['Lips'] > df['Teeth']) & (df['Teeth'] > df['Jaw']) & (df['ST_dir'] == 'up') & (df['ST_dir'].shift(1) == 'down')
df['Sell'] = (df['Lips'] < df['Teeth']) & (df['Teeth'] < df['Jaw']) & (df['ST_dir'] == 'down') & (df['ST_dir'].shift(1) == 'up')
