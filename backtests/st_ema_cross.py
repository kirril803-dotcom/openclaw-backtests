...
# Buy: EMA9 crosses above EMA21 + ST bullish
df['Buy'] = (df['EMA9'] > df['EMA21']) & (df['EMA9'].shift(1) <= df['EMA21'].shift(1)) & (df['ST_dir'] == 'up')
df['Sell'] = (df['EMA9'] < df['EMA21']) & (df['EMA9'].shift(1) >= df['EMA21'].shift(1)) & (df['ST_dir'] == 'down')
