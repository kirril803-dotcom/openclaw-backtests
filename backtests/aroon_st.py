...
# Buy: Aroon bullish + ST bullish
df['Buy'] = (df['AroonUp'] > df['AroonDown']) & (df['ST_dir'] == 'up') & (df['ST_dir'].shift(1) == 'down')
df['Sell'] = (df['AroonUp'] < df['AroonDown']) & (df['ST_dir'] == 'down') & (df['ST_dir'].shift(1) == 'up')
