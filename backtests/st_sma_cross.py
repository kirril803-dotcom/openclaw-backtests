...
# Buy: SMA9 crosses above SMA21 + ST bullish
df['Buy'] = (df['SMA9'] > df['SMA21']) & (df['SMA9'].shift(1) <= df['SMA21'].shift(1)) & (df['ST_dir'] == 'up')
df['Sell'] = (df['SMA9'] < df['SMA21']) & (df['SMA9'].shift(1) >= df['SMA21'].shift(1)) & (df['ST_dir'] == 'down')
