...
# Buy: Price touches Lower envelope + ST bullish
df['Buy'] = (df['Close'] <= df['Lower']) & (df['ST_dir'] == 'up') & (df['ST_dir'].shift(1) == 'down')
df['Sell'] = (df['Close'] >= df['Upper']) & (df['ST_dir'] == 'down') & (df['ST_dir'].shift(1) == 'up')
