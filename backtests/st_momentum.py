...
# Buy: Momentum positive + ST bullish
df['Buy'] = (df['Momentum'] > 0) & (df['Momentum'].shift(1) <= 0) & (df['ST_dir'] == 'up')
df['Sell'] = (df['Momentum'] < 0) & (df['Momentum'].shift(1) >= 0) & (df['ST_dir'] == 'down')
