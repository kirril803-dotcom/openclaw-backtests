...
# Buy: TEMA9 crosses above TEMA21 + ST bullish
df['Buy'] = (df['TEMA9'] > df['TEMA21']) & (df['TEMA9'].shift(1) <= df['TEMA21'].shift(1)) & (df['ST_dir'] == 'up')
df['Sell'] = (df['TEMA9'] < df['TEMA21']) & (df['TEMA9'].shift(1) >= df['TEMA21'].shift(1)) & (df['ST_dir'] == 'down')
