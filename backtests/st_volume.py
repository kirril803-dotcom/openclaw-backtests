...
# Buy when ST direction changes and volume is high
df['Buy'] = (df['ST_dir'] == 'up') & (df['ST_dir'].shift(1) == 'down') & df['HighVol']
df['Sell'] = (df['ST_dir'] == 'down') & (df['ST_dir'].shift(1) == 'up') & df['HighVol']
