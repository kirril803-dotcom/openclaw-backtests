...
# Buy: K crosses above D + ST bullish
df['Buy'] = (df['K'] > df['D']) & (df['K'].shift(1) <= df['D'].shift(1)) & (df['ST_dir'] == 'up')
df['Sell'] = (df['K'] < df['D']) & (df['K'].shift(1) >= df['D'].shift(1)) & (df['ST_dir'] == 'down')
