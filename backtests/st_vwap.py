...
# Buy: price above VWAP + ST bullish
df['Buy'] = (df['Close'] > df['VWAP']) & (df['ST_dir'] == 'up') & (df['ST_dir'].shift(1) == 'down')
df['Sell'] = (df['Close'] < df['VWAP']) & (df['ST_dir'] == 'down') & (df['ST_dir'].shift(1) == 'up')
