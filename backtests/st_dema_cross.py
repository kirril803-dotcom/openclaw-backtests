...
# Buy: DEMA9 crosses above DEMA21 + ST bullish
df['Buy'] = (df['DEMA9'] > df['DEMA21']) & (df['DEMA9'].shift(1) <= df['DEMA21'].shift(1)) & (df['ST_dir'] == 'up')
df['Sell'] = (df['DEMA9'] < df['DEMA21']) & (df['DEMA9'].shift(1) >= df['DEMA21'].shift(1)) & (df['ST_dir'] == 'down')
